        ...
        <div className="px-4 md:px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <button 
              ...
              className="md:hidden text-foreground p-2 hover:bg-muted rounded-lg transition"
            >
            ...
            <div
              className="text-xl font-black bg-gradient-to-r from-emerald-500 to-green-600 bg-clip-text text-transparent cursor-pointer"
              onClick={() => navigate('/')}
            >
              SWIFTLINE
            </div>
          ...
          <div className="flex items-center gap-4">
            <button className="relative p-2 text-foreground hover:bg-muted rounded-lg transition">
              <Bell size={24} />
            </button>
