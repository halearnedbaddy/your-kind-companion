  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {hasChanges && (
          <span className="text-sm text-amber-600 bg-amber-50 dark:bg-amber-900/20 px-3 py-1 rounded-full">
            Unsaved changes
          </span>
        )}
      </div>
          ...
          <div className="relative group">
            {formData.logo ? (
              <img 
                src={formData.logo} 
                alt="Store logo" 
                className="w-24 h-24 object-cover rounded-xl ring-2 ring-border"
              />
            ) : (
              <div className="w-24 h-24 bg-muted rounded-xl flex items-center justify-center ring-2 ring-border">
          ...
          <div>
            <label className="block">
              <input
                ...
                className="hidden"
              />
              <span className="px-4 py-2 rounded-lg bg-primary text-primary-foreground cursor-pointer hover:bg-primary/90 transition inline-block font-medium">
                Upload Logo
              </span>
            </label>
      ...
      <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border bg-background text-foreground focus:outline-none focus:ring-2 ${
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-lg border border-input bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none"
            rows={4}
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        ...
        <div className="space-y-3">
          <label className="flex items-start gap-4 p-4 border border-input rounded-lg cursor-pointer hover:bg-muted/50 transition">
            <input
              type="radio"
              name="visibility"
              value="PRIVATE"
      ...
      <div className="flex justify-end gap-3">
        {hasChanges && (
          <button
            ...
            className="px-6 py-3 border border-input rounded-lg hover:bg-muted transition font-medium text-foreground"
          >
            Discard Changes
          </button>
        )}
        <button
          ...
          className="px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition font-medium flex items-center gap-2 disabled:opacity-50"
        >
          {isSaving ? (
            <>
