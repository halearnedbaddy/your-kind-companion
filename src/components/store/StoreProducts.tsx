              ...
              >
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                    ...
                    {product.status === 'PUBLISHED' && (
                      <button
                        ...
                        className="p-2 bg-orange-500 rounded-full hover:bg-orange-600 transition"
                        title="Archive"
                      >
                ...
                <div className="p-4">
                  ...
                  {paymentLink ? (
                    ...
                    <button
                      onClick={() => handlePublish(product)}
                      className="w-full text-sm px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition font-medium flex items-center justify-center gap-2"
                    >
                      <CheckIcon size={14} />
                      Publish to Get Link
                    </button>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-2xl p-6 w-full max-w-md shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="flex gap-3 mb-3">
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    ...
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-3 py-2 border border-input rounded-lg hover:bg-muted transition text-sm font-medium text-foreground"
                    >
                      <UploadIcon size={16} />
                      Upload Image
                    </button>
                    <button 
                      type="button"
                      className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gradient-to-r from-cyan-400 to-pink-400 rounded-lg hover:opacity-90 transition text-sm font-medium text-white"
                      onClick={() => {
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-input bg-muted/50 text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 rounded-xl border border-input bg-muted/50 text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition resize-none"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              <button
                onClick={() => setShowAddModal(false)}
                className="flex-1 px-4 py-3 border border-input rounded-xl hover:bg-muted transition font-medium text-foreground"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-primary to-pink-500 text-white rounded-xl hover:opacity-90 transition font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-xl p-6 w-full max-w-md shadow-xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex gap-3">
                  {editForm.imageUrl ? (
                    <div className="relative w-16 h-16 rounded-lg overflow-hidden border border-border">
                      ...
                      <button
                        ...
                        className="absolute top-1 right-1 p-0.5 bg-red-500 rounded-full hover:bg-red-600 transition"
                      >
                  ...
                  <div className="flex-1">
                    ...
                    <button 
                      ...
                      className="w-full flex items-center justify-center gap-2 px-3 py-2 border border-input rounded-lg hover:bg-muted transition text-sm font-medium text-foreground"
                    >
                      <UploadIcon size={14} />
                      Change Image
                    </button>
            ...
            <div className="flex gap-3 mt-6">
              <button
                onClick={() => setEditingProduct(null)}
                className="flex-1 px-4 py-2 border border-input rounded-lg hover:bg-muted transition font-medium text-foreground"
              >
                Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="flex-1 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition font-medium flex items-center justify-center gap-2"
              >
