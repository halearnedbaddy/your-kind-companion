...
import { 
  BellIcon, CheckCheckIcon, XIcon, AlertTriangleIcon, DollarSignIcon, UsersIcon, 
  ShoppingBagIcon, GavelIcon, StoreIcon, ActivityIcon, WifiIcon, WifiOffIcon 
...
const getNotificationIcon = (type: string) => {
  switch (type) {
    ...
    case 'PAYMENT_RECEIVED':
      return <DollarSignIcon className="h-4 w-4 text-[#88BDBC]" size={16} />;
    case 'DISPUTE_OPENED':
    ...
    case 'STORE_CREATED':
      return <StoreIcon className="h-4 w-4 text-[#88BDBC]" size={16} />;
    default:
