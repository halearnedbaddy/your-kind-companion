...
import { ArrowRightIcon, PhoneIcon, RefreshCwIcon } from '@/components/icons';
import { z } from 'zod';
        ...
        <div className="min-h-screen flex bg-white">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="max-w-md w-full">
                    ...
                    {devOtp && (
                        <div className="mb-6 p-4 bg-[#6E6658]/10 border border-[#6E6658]/30 rounded-xl text-[#6E6658] text-sm">
                            <strong>Dev Mode:</strong> Your OTP is <code className="font-mono bg-[#6E6658]/20 px-2 py-1 rounded">{devOtp}</code>
                        </div>
                    )}
